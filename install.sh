...
{
  echo "[+] Creating files..."
    cp gdb-peda ~/.local/bin/gdb-peda &&\
    cp gdb-peda-arm ~/.local/bin/gdb-peda-arm &&\
    cp gdb-peda-intel ~/.local/bin/gdb-peda-intel &&\
    cp gdb-pwndbg ~/.local/bin/gdb-pwndbg &&\
    cp gdb-gef ~/.local/bin/gdb-gef
} || {
